...
WebUI.setText(findTestObject('Object Repository/List Deletion Objects/Page_Sybrin Enterprise Studio/input_User Name_usernameBox'), 
    'admin')
(WebUI.delay(1))
WebUI.setEncryptedText(findTestObject('Object Repository/List Deletion Objects/Page_Sybrin Enterprise Studio/input_Password_passwordBox'), 
    'RAIVpflpDOg=')
(WebUI.delay(1))
WebUI.click(findTestObject('Object Repository/List Deletion Objects/Page_Sybrin Enterprise Studio/button_Log In'))
(WebUI.delay(1))
